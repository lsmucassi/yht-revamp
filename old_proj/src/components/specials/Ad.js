													...
													<div class="single-tab-select-box">
														...
														<div class="travel-select-icon">
															<select class="form-control ">
															  	...
															  	<option value="default">enter your tour choice </option><!-- /.option-->

															  	<option value="turkey">Johannesburg & Soweto Day Tour
																</option><!-- /.option-->

															  	<option value="russia">Pilanesburg Day Tour
																</option><!-- /.option-->
															  	<option value="egept">Pretoria Half Day Tour​
																</option><!-- /.option-->
																<option value="egept">PUkutula Lion Park & Lesedi Cultural Village
																</option>
